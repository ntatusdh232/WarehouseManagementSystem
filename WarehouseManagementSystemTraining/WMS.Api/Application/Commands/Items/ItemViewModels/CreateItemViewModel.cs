namespace WMS.Api.Application.Commands.Items.ItemViewModels
{
    public class CreateItemViewModel
    {
        ...
        public CreateItemViewModel(string itemId, string itemName, double minimumStockLevel, decimal price, string itemClassId, string unit, double? packetSize, string? packetUnit)
        {
            ItemId = itemId;
            ItemName = itemName;
