...
public class CreateLotAdjustmentCommand : IRequest<bool>
{
    ...
    public CreateLotAdjustmentCommand(string lotId, string itemId, double afterQuantity, string unit, string employeeName, string note, List<CreateSublotAdjustmentViewModel> sublotAdjustments)
    {
        LotId = lotId;
        ItemId = itemId;
